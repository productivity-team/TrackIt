...
extension MenuRouter: MenuRouterInput {
    ...
    func showHabit(model: HabitViewModel) {
        ...
        let container = HabitContainer.assemble(with: HabitContext(title: model.title, target: model.target, numberOfCompletions: model.numberOfCompletions, units: model.units, habitIconColor: model.habitIconColor ))
